...
while True: # main game loop
    ...
    for i in reversed(range(min(loops-1,GHOST_FRAMES-1))):
        ...
        pygame.draw.line(DISPLAYSURF, color, pos_history[i][0], pos_history[i+1][0],
